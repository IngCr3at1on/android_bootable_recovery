...
*/
int maxX=320;		//Set to 0 for debugging (LGE-LS/VM670: 320, LGE-M690: 1808, AmazonOtter: 1024)
int maxY=480;		//Set to 0 for debugging (LGE-LS/VM670: 480, LGE-M690: 2704, AmazonOtter: 600)
...
*/
int resX=320;		//Value obtained from function 'gr_fb_width()' (LGE-LS/VM670, M690: 320, AmazonOtter: 1024)
int resY=480;		//Value obtained from function 'gr_fb_height()' (LGE-LS/VM670, M690: 480, AmazonOtter: 600)
 ...
 */
int touchY=400;		// (LGE-LS/VM670, M690: 400, AmazonOtter: 0)
